...
public class ServiceRegistrationGeneratorTests
{
    ...
    [Fact]
    public void Generator_WithSingletonAttribute_ShouldGenerateSingletonRegistration()
    {
        // Arrange
        var sourceCode = """
    ...
    public void Generator_WithScopedAttribute_ShouldGenerateScopedRegistration()
    {
        ...
        Assert.Contains("Scoped", generatedCode);
    }
    ...
    [Fact]
    public void Generator_WithNonMatchingPattern_ShouldNotGenerateRegistration()
    {
        // Arrange
        var sourceCode = """
            namespace TestApp
        ...
        // Assert
        Assert.DoesNotContain("MyHelper", generatedCode);
    }

    [Fact]
    public void Generator_WithWildcardPattern_ShouldMatchCorrectly()
    {
        // Arrange
        var sourceCode = """
            namespace TestApp
        ...
        // Pattern must match full qualified name (TestApp.UserService), so use *Service*
        var configJson = """
            {
                "RegisterTypesMatching": ["*Service*"]
            }
        ...
        Assert.DoesNotContain("Helper", generatedCode);
    }
    ...
    [Fact]
    public void Generator_WithAutoActivateSingleton_ShouldGenerateAutoActivation()
    {
        // Arrange
        var sourceCode = """
            using Tools.ContainerRegistration.Attributes;
        ...
        // Assert
        Assert.Contains("AutoActivatedService", generatedCode);
        Assert.Contains("AfterContainerBuilt", generatedCode);
    }

    [Fact]
    public void PatternMatching_WithFullNamespace_ShouldMatchCorrectly()
    {
        // Arrange
        var sourceCode = """
        ...
        // Assert
        Assert.Contains("DeepService", generatedCode);
    }

    [Fact]
    public void PatternMatching_WithNamespacePattern_ShouldMatchCorrectly()
    {
        // Arrange
        var sourceCode = """
        ...
        var configJson = """
            {
                "RegisterTypesMatching": ["TestApp.ViewModels.*"]
            }
            """;
        ...
        // Assert
        Assert.Contains("MainViewModel", generatedCode);
        Assert.Contains("SettingsViewModel", generatedCode);
        Assert.DoesNotContain("DataService", generatedCode);
    }
    ...
    private static string RunGenerator(string sourceCode, string? configJson = null)
    {
        ...
        var generator = new MicrosoftServiceRegistrationGenerator();
